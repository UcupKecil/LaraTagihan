...
@endpush
@section('content_title', 'Pembayaran Tahun '.$ipl->tahun)
@section('content')
<x-alert></x-alert>
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <a href="{{ route('pembayaran.status-pembayaran.show',$penghuni->nik) }}" class="btn btn-danger btn-sm">
      ...
      <div class="card-body">
        ...
        <table id="dataTable2" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <td>{{ $row->penghuni->nama_penghuni }}</td>
            <td>{{ $row->penghuni->kelas->nama_kelas }}</td>
            <td>{{ $row->nik }}</td>
        ...
        <div class="alert alert-danger" role="alert">
          ...
          <p>Pembayaran Ipl {{ $penghuni->nama_penghuni }} di Tahun {{ $ipl->tahun }} tidak tersedia.</p>
        </div>
        @endif
      </div>
      <!-- /.card-body -->
      ...
      <div class="card-body">
        ...
        <table id="" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <td>
              @if(Universe::statusPembayaran($penghuni->id, $ipl->tahun, $value['nama_bulan']) == 'DIBAYAR')
                <a href="javascript:(0)" class="btn btn-success btn-sm"><i class=""></i>
                  {{ Universe::statusPembayaran($penghuni->id, $ipl->tahun, $value['nama_bulan']) }}
                </a>
              @else
        ...
        <div class="alert alert-danger" role="alert">
          ...
          <p>Status Pembayaran Ipl {{ $penghuni->nama_penghuni }} di Tahun {{ $ipl->tahun }} tidak tersedia.</p>
        </div>
        @endif
      </div>
      <!-- /.card-body -->
