  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <a href="{{ route('penghuni.pembayaran-ipl') }}" class="btn btn-danger btn-sm">
      ...
      <div class="card-body">
        ...
        <div class="alert alert-danger" role="alert">
          ...
          <p>Pembayaran Ipl Anda di Tahun {{ $ipl->tahun }} tidak tersedia.</p>
        </div>
        @endif
      </div>
      <!-- /.card-body -->
      ...
      <div class="card-body">
        ...
        <table id="" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <td>
              @if(Universe::statusPembayaranBulan($value['nama_bulan'], $ipl->tahun) == 'DIBAYAR')
                <a href="javascript:(0)" class="btn btn-success btn-sm"><i class=""></i>
                  {{ Universe::statusPembayaranBulan($value['nama_bulan'], $ipl->tahun) }}
                </a>
              @else
        ...
        <div class="alert alert-danger" role="alert">
          ...
          <p>Status Pembayaran Ipl Anda di Tahun {{ $ipl->tahun }} tidak tersedia.</p>
        </div>
        @endif
      </div>
      <!-- /.card-body -->
