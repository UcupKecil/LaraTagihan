...
<br><br>
<center>
  <h2 style="font-family: sans-serif;">History Pembayaran IPL</h2>
</center>
<br>
<div style="float: left;">
  <b style="font-family: sans-serif;">Nama Penghuni : {{ $pembayaran->penghuni->nama_penghuni }}</h3><br>
  <b style="font-family: sans-serif;">Cluster : {{ $pembayaran->penghuni->kelas->nama_kelas }}</b><br>
  <b style="font-family: sans-serif;">Nik : {{ $pembayaran->penghuni->nik }}</b><br>
