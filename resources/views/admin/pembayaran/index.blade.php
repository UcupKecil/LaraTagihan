...
<div class="row">
  <div class="col-12">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('importpembayaran') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="file" name="file" class="form-control">
                <br>
                <button class="btn btn-success">Import Pembayaran</button>
                <a class="btn btn-warning" href="{{ route('exportpembayaran') }}">Export Pembayaran</a>
            </form>
        </div>
...
<script>
 $(function () {
  ...
  var table = $("#dataTable2").DataTable({
      ...
      serverSide: true,
      "responsive": true,
      ajax: "{{ route('pembayaran-ipl.index') }}",
      columns: [
