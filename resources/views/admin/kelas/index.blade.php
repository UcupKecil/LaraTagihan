...
@endpush
@section('content_title', 'Data Cluster')
@section('content')
<div class="row">
  <div class="col-12">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('importkelas') }}" method="POST" enctype="multipart/form-data">
                ...
                <br>
                <button class="btn btn-success">Import Cluster Data</button>
                <a class="btn btn-warning" href="{{ route('exportkelas') }}">Export Cluser Data</a>
            </form>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="deskripsi_create">Komptensi Keahlian:</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="deskripsi_edit">Komptensi Keahlian:</label>
