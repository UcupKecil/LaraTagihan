...
@endpush
@section('content_title', 'Data Konfirmasi')
@section('content')
<div class="row">
  <div class="col-12">
    <div class="card">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="cover">Konfirmasi Pembayaran</label>
          ...
          <div class="form-group">
            <label for="deskripsi_create">Deskripsi:</label>
            <input required type="" name="deskripsi" id="deskripsi_create" class="form-control">
          </div>

            <div class="form-group">
              <label for="penghuni_id">Penghuni:</label>
              <select required="" name="penghuni_id" id="penghuni_id" class="form-control select2bs4">
                <option disabled="" selected="">- PILIH PENGHUNI -</option>
                @foreach($penghuni as $row)
                  <option value="{{ $row->id }}">{{ $row->nama_penghuni }}</option>
                @endforeach
              </select>
            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="" name="deskripsi" id="deskripsi_edit" class="form-control">
          </div>
          <div class="form-group">
            <label for="penghuni_id_edit">Penghuni:</label>
            <select required="" name="penghuni_id" id="penghuni_id_edit" class="form-control">
              @foreach($penghuni as $row)
                <option value="{{ $row->id }}">{{ $row->nama_penghuni }}</option>
              @endforeach
            </select>
